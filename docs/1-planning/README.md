# 1-planning · 路线与产品定位（开发组决策文档）

开发组层面的规划、调研与定位文档。**改动即决策**：这里的文档修订视为开发组的决策更新。

## 内容约定

- 产品定位、竞争格局、路线图（能力阶梯 L0–L3 与 Phase 映射）
- 技术选型决策记录（D1–D3 等决策点及其结论）
- 调研报告（竞品、生态、开源项目清单）
...
- 具体实现文档见 [../2-dev/](../2-dev/)；与本文档冲突时，以本文档的决策为准并回写修订。
