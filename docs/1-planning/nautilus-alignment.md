...
> 版本 **v0.1（2026-09-28 起草，待守谷人逐条签核）**。
...
| 编号 | 事项 | 现状 |
|---|---|---|
| **签-1** | §2.1 锚文（1–5 + 判例）是否即为锁版文本 | **待签** |
| **签-2** | 「4 与 5 都必附引文」是否维持（可降为仅 5） | **待签**（我建议维持，承「最强断言配最强把手」） |
| **签-3** | N/A 豁免保留（纯操作性轮不进分母） | **待签**（我建议保留） |
| **签-4** | 术语表（A 改称分辨率提升速率；契合与 L 场废止） | **待签** |
| **签-5** | 里程顺序与 AL.5 的 N≥50 阈值 | **待签** |
| **签-6** | `rubric_version` 起始值 = `al-v1` | **待签** |
