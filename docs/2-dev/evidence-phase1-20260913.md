...
7. **DOM / 交互层**：§E10–E12 覆盖到「宿主启动图 → rev → bundle 字节 → 只读 API」为止；侧栏图标是否出现、六视图是否成形、抽屉与标注写路径的实际交互，均需人在既有页面确认。**2026-09-24 更新**：**OQ-U6 已闭合**——图表语法升级与 U2 令牌层两批均已端上目视（协议与可观察量见 [evidence-u2-20260924.md](./evidence-u2-20260924.md) §5，守谷人判「验证通过，收敛」）。**U3 新增的告警 UI（手动档盲区条 / 两处口径注记 / 报告衬线排版）尚未目视**，验收清单见 [evidence-u3-20260924.md](./evidence-u3-20260924.md) §3。
