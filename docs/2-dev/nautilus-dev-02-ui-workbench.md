...
- **OQ-U7（待裁决）**：是否接受「浅色下也把三级面交给宿主」＝工作台整片白、只靠发丝线分层（更贴宿主、更失去 S4 图纸感）？未裁决前按本文档自持。
...
| 端上双态目视验收 | 既有页面刷新后人工确认（亮/暗两态 + 手动档三态截图） | ⏳ 待守谷人（§8 视觉验收） |
...
- ~~OQ-U7 面层是否也交给宿主~~ **本轮新提（§2.3）**：浅色下三级面自持 S4 定版值 vs 全交宿主（整片白）；未裁决前按自持执行。
