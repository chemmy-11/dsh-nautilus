...
| [evidence-u3-20260924.md](./evidence-u3-20260924.md) | 证据归档 · **U3（A.4 UI 线续作）**：告警视图入册（dev-02 §3.2，原型无此页）· 手动档盲区条（修 dev-06「已在 UI 明示」的失实声明）· 两处口径注记 · 报告衬线排版 · 图标三态 a11y | 已归档（门禁 57/57 · A 系 17/17；端上六步目视待守谷人） |
